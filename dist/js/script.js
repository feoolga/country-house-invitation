...
// По клику на маленькую картинку открывается большая картинка //--/--/--/--/--/--/--/--/--/--/--/--/--/--//
...
// Определение мобильный или нет. В данном случае для блока с параллакс-эффектом //--/--/--/--/--/--/--/--/--/--/--/--/--/--//
